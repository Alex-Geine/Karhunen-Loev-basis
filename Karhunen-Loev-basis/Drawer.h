...
public:
	...
	// Нарисовать график по переданным данным(точками)
	void DrawOnePoints(vector<double>& data, double data_x_min, double data_x_max, double data_y_min, double data_y_max, char A1, char A2, vector<double>& keys = vector<double>())
	{
		if (!init) return;
