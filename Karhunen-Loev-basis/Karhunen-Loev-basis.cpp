...
// Karhunen-Loev-basis.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKarhunenLoevbasisApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKarhunenLoevbasisApp

CKarhunenLoevbasisApp::CKarhunenLoevbasisApp()
{
...
// Единственный объект CKarhunenLoevbasisApp

CKarhunenLoevbasisApp theApp;


// Инициализация CKarhunenLoevbasisApp

BOOL CKarhunenLoevbasisApp::InitInstance()
{
